          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="nama_guru_post" class="form-control" placeholder="Masukan Nama guru " required>
                <label>nip </label>
                <input type="text" name="nip_post" class="form-control" placeholder="Masukan nip guru " required>
                <label>mata pelajaran </label>
                <input type="text" name="pelajaran_post" class="form-control" placeholder="Masukan mata pelajaran guru " required>
              </div>
              <div class="form-group">
                <div class="form-group">
