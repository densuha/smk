...
$query = mysqli_query($koneksi, "SELECT * FROM guru WHERE id 
= '$id'");
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php?page=guru">Home</a></li>
          ...
          <form action="proses_edit.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_guru_post" class="form-control" placeholder="Masukan Nama guru " value="<?= $nama_guru ?>" required>
                <label>NIP </label>
                <input type="text" name="nip_post" class="form-control" placeholder="Masukan NIP guru " value="<?= $nip ?>" required>
                <label>Mata_Pelajaran </label>
                <input type="text" name="pelajaran_post" class="form-control" placeholder="Masukan Mata Pelajaran guru " value="<?= $pelajaran ?>" required>
              </div>
              <div class="form-group">
            ...
            <div class="card-footer">
              ...
              <a href="index.php?page=guru" type="button" class="btn 
