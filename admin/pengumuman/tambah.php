    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Tambah Data pengumuman </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php?page=pengumuman">Home</a></li>
                <li class="breadcrumb-item 
active">Tambah Data pengumuman </li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section class="content">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Form Data pengumuman</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <!-- Input untuk tanggal pengumuman -->
    ...
    <input type="date" name="tanggal_post" required><br>
        ...
        <div class="card-footer">
          ...
          <a href="index.php?page=pengumuman" type="button" class="btn 
