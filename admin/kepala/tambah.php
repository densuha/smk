    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Tambah Data Kepala Sekolah</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php?page=kepala">Home</a></li>
                <li class="breadcrumb-item active">Tambah Data kepala Sekolah </li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section class="content">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Form Data Kepala Sekolah</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="proses_simpan.php?page=kepala" method="post" enctype="multipart/form-data">
            <div class="card-body">
        ...
        <div class="card-footer">
          ...
          <a href="index.php?page=kepala" type="button" class="btn btn-default">kembali</a>
        </div>
        </form>
    </div>
    </section>
